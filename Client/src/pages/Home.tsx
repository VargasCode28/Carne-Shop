  ...
  return (
    <section className="hero py-5 bg-light">
      <div className="container">
        ...
        <br />
        <hr className="my-5" />
        <div className="contact-form bg-white p-4 rounded-4 shadow-sm">
          ...
          <form onSubmit={(e) => {
            ...
            <div className="mb-3">
              ...
              <input type="email" className="form-control" id="correo" placeholder="tucorreo@ejemplo.com" required />
            </div>
            <div className="mb-3">
