...
const Navbar: React.FC<NavbarProps> = ({ busqueda, setBusqueda }) => {
  ...
  const handleLogout = async () => {
    const result = await Swal.fire({
      title: "¿Cerrar sesión?",
      text: "Tu sesión actual se cerrará y volverás al login.",
      icon: "warning",
  ...
  return (
    <nav
      className={`navbar navbar-expand-lg navbar-light bg-white border-bottom px-4 py-2 shadow-sm ${
